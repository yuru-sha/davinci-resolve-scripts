...
def add_frame(image_path):
    ...
    border_uniform = int(base_dim * 0.05)
    border_bottom = int(border_uniform * 3.6)
...
def main():
    ...
    print(f"Processing Timeline Clip: {file_path}")
    try:
        output = add_frame(file_path)
        if output:
